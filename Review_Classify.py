...
def parse_args():
    ...
    parser.add_argument("--model_name", type=str, default="ROBERTA_CLS", help="The path of used model.(Choice : ROBERTA_CLS,BERT_CLS)")
    parser.add_argument("--dataset", type=str, default="llama3", help="The dataset to use.")
    ...
    parser.add_argument("--hidden_size", type=int, default=768, help="The size of gcn output hidden size.")
...
print("gcn_hidden_size", hidden_size)
print("-------------------------------------------------")
...
# valid_tokenized_data = train_tokenized_data[:50]
...
print("Validation set length:", len(valid_dataset))
